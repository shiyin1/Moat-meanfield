...
pmin1=np.loadtxt('./ET2.dat')
pmin2=np.loadtxt('./pmin.dat')
T1=np.loadtxt('./T2.dat')
T2=np.loadtxt('./T1.dat')
...
ax1.plot(T,pmin/pfermi,'b-',linewidth=1.5,alpha=0.6,label=r'$\mu=320\,\mathrm{MeV}$')
#ax1.text(221,1.2,r'$\mu=290\,\mathrm{MeV}$',fontsize=10)
ax1.axis([0,40,0.85,1.15])

ax1.set_xlabel('$T\,[\mathrm{MeV}]$', fontsize=14, color='black')
ax1.set_ylabel('$p_{\mathrm{min}}/p_{\mathrm{fermi}}$', fontsize=14, color='black')
