...
%$\displaystyle
$\includegraphics[width=0.2\textwidth,valign=c]{Gam2-quark.eps}^{-1}=\includegraphics[width=0.2\textwidth,valign=c]{Gam2-quark-bare.eps}^{-1}+\includegraphics[width=0.2\textwidth,valign=c]{Gam2-quark-Vqmeson.eps}$
