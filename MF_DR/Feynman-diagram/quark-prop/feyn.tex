...
%       		\fmf{quark,left=1,label=$q$}{v2,v1}
                \fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{v1,i}
                \fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{o,v1}
...
%        		\fmf{quark,fore=black,left=1,label=$(q-p)$}{v1,v2}
%       		\fmf{quark,left=1,label=$q$}{v2,v1}
                \fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{o,i}
                %\fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{o,v1}
...
% %        		\fmf{quark,fore=black,left=1,label=$(q-p)$}{v1,v2}
% %       		\fmf{quark,left=1,label=$q$}{v2,v1}
%                 \fmf{plain_arrow,tension=1,label=$p$,label.side=right,fore=black,width=0.8thick}{v1,i}
%                 \fmf{plain_arrow,tension=1,label=$p$,label.side=right,fore=black,width=0.8thick}{o,v1}
...
%                 \fmffreeze                
%                 \fmfiv{label=$i$,l.a=-150,l.d=0.1w}{vloc(__v1)}
%                 \fmfiv{label=$j$,l.a=-30,l.d=0.1w}{vloc(__v1)}
...
%                 \fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{v1,o1}
%                 \fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{o2,v1}
%                 \fmffreeze                


% %                \fmf{phantom,tension=6}{i,v1}
% %                \fmf{dashes,left=1,tension=1,fore=blue,width=0.5thick}{i,v1}
%                 \fmf{plain_arrow,right=1,tension=0.8,fore=black,width=0.8thick}{v1,v1}
% %                \fmf{dashes,tension=3,fore=blue,width=0.5thick}{v2,o}

% %	        \fmfv{decor.shape=circle,decor.filled=empty,decor.size=2thick,fore=black}{i}
% 		\fmfv{decor.shape=circle,decor.filled=empty,decor.size=6thick,b=(0.5,,0.5,,0.5)}{v1}

% %                \fmfv{label=$q$,l.a=120,l.d=0.05w}{i}
% %                \fmfv{label=$c$,l.a=120,l.d=0.07w}{v1}
               
% %                \fmffreeze                
% %                \fmfiv{label=$q$,l.a=60,l.d=0.05w}{vloc(__i)}
% %                \fmfiv{label=$c$,l.a=60,l.d=0.07w}{vloc(__v1)}
% %                \fmfiv{label=$q$,l.a=-150,l.d=0.07w}{vloc(__v1)}
% %                \fmfiv{label=$c$,l.a=-30,l.d=0.07w}{vloc(__v1)}
...
%       		\fmf{quark,left=1,label=$q$}{v2,v1}
                ...
                \fmf{plain_arrow,tension=2,fore=black,width=0.8thick}{o2,v2}
                \fmf{plain_arrow,tension=1,fore=black,width=0.8thick}{v2,v1}
                \fmf{plain_arrow,tension=2,fore=black,width=0.8thick}{v1,o1}
                \fmffreeze                


%                \fmf{phantom,tension=6}{i,v1}
%                \fmf{dashes,left=1,tension=1,fore=blue,width=0.5thick}{i,v1}
                \fmf{curly,right=1.2,tension=1,fore=black,width=0.8thick}{v2,v1}
%                \fmf{dashes,tension=3,fore=blue,width=0.5thick}{v2,o}
...
%                \fmf{phantom,tension=6}{i,v1}
%                \fmf{dashes,left=1,tension=1,fore=blue,width=0.5thick}{i,v1}
                \fmf{double,right=0,tension=4,fore=(1,,1,,1),width=0.8thick}{i,v3}
                \fmf{double,right=0.5,tension=1,fore=(0,,0.1,,1),width=0.8thick}{v3,v1}
                \fmf{double,right=0.5,tension=1,fore=(0,,0.1,,1),width=0.8thick}{v2,v3}
                \fmffreeze                
%                \fmf{dashes,tension=3,fore=blue,width=0.5thick}{v2,o}

%	        \fmfv{decor.shape=circle,decor.filled=empty,decor.size=2thick,fore=black}{i}
		\fmfv{decor.shape=circle,decor.filled=1,decor.size=3thick,b=(0.5,,0.5,,0.5)}{v1,v2}
		\fmfv{decor.shape=circle,decor.filled=empty,decor.size=6thick,b=(0.5,,0.5,,0.5)}{v3}
%                \fmfv{label=$q$,l.a=120,l.d=0.05w}{i}
%                \fmfv{label=$c$,l.a=120,l.d=0.07w}{v1}
