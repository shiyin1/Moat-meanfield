...
%$\displaystyle
$\includegraphics[width=0.2\textwidth,valign=c]{Gam2-meson.eps}^{-1}=\includegraphics[width=0.2\textwidth,valign=c]{Gam2-meson-bare.eps}^{-1}+\includegraphics[width=0.2\textwidth,valign=c]{pi2-quark.eps}$
