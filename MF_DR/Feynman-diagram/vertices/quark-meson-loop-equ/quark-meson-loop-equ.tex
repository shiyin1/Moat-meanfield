...
%$\displaystyle
$\partial_t\includegraphics[width=0.2\textwidth,valign=c]{quark-meson.eps}=\tilde{\partial}_t\left(-\includegraphics[width=0.2\textwidth,valign=c]{q2-A1-loop.eps}-\includegraphics[width=0.2\textwidth,valign=c]{q2-meson-loop.eps}-\includegraphics[width=0.2\textwidth,valign=c]{q1-meson2-loop.eps}\right)$
