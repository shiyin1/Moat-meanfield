...
%$\displaystyle
$\includegraphics[width=0.2\textwidth,valign=c]{quark-meson.eps}=\includegraphics[width=0.2\textwidth,valign=c]{quark-meson2.eps}+\includegraphics[width=0.2\textwidth,valign=c]{q2-meson-loop.eps}$
