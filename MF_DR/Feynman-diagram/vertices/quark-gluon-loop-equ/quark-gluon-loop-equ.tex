...
%$\displaystyle
$\partial_t\includegraphics[width=0.2\textwidth,valign=c]{quark-gluon.eps}=\tilde{\partial}_t\left(-\includegraphics[width=0.2\textwidth,valign=c]{q2-A1-loop.eps}-\includegraphics[width=0.2\textwidth,valign=c]{q2-meson-loop.eps}-\includegraphics[width=0.2\textwidth,valign=c]{q1-A2-loop.eps}\right)$
