...
%$\displaystyle
$\partial_t\includegraphics[width=0.2\textwidth,valign=c]{A3-gluon.eps}=\tilde{\partial}_t\left(-\includegraphics[width=0.2\textwidth,valign=c]{A3-quark-loop.eps}-\includegraphics[width=0.2\textwidth,valign=c]{A3-ghost-loop.eps}+\includegraphics[width=0.2\textwidth,valign=c]{A3-gluon-loop.eps}+\includegraphics[width=0.2\textwidth,valign=c]{A3-gluon-tadpole.eps}\right)$
