...
ax1.plot(p,Zdata,c='#08306b',linewidth=2.5,alpha=0.8,label=r'$Z^\perp_\pi$')
ax1.plot(Thigh,Zvac,c='#6baed6',linewidth=2.5,alpha=0.8,label=r'Vacuum part')
ax1.plot(Thigh,Zca+Zvac,c='#fc9271',dashes=[3,1,1,1],linewidth=2.5,alpha=0.8,label=r'CA part')
ax1.plot(Thigh,Zph,c='#a50f15',dashes=[1,1],linewidth=2.5,alpha=0.8,label=r'PH part')
...
fig=plt.figure(figsize=(4.5, 3.5))
ax1=plt.subplot(1,1,1)
ax1.plot(Thigh,Zvacmu320+Zphmu320+Zcamu320,c='#08306b',linewidth=2.5,alpha=0.8,label=r'$Z^\perp_\pi$ at $\mu=320$ MeV')
ax1.plot(Thigh,Zvacmu320,c='#6baed6',linewidth=2.5,alpha=0.8,label=r'Vacuum part')
ax1.plot(Thigh,Zcamu320+Zvacmu320,c='#fc9271',dashes=[3,1,1,1],linewidth=2.5,alpha=0.8,label=r'CA part')
ax1.plot(Thigh,Zphmu320,c='#a50f15',dashes=[1,1],linewidth=2.5,alpha=0.8,label=r'PH part')

ax1.text(300,3,r'$\mu=320$ $\mathrm{MeV}$',fontsize=15)
ax1.plot([0,2000],[0,0],dashes=[1,1],color='k',alpha=0.2,linewidth=1) 

ax1.set_xscale('log')
ax1.axis([10.,2000,-2,5])
#ax1.legend(loc=0,fontsize=10,frameon=False,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1,scatterpoints=1)
