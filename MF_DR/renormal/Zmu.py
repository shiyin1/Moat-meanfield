...
ax1.scatter(T,mu0,color='#08306b',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=0$')
ax1.scatter(T,mu100,color='#2170b5',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=100\,\mathrm{MeV}$')
ax1.scatter(T,mu200,color='#6baed6',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=200\,\mathrm{MeV}$')
ax1.scatter(T,mu250,color='#c6dbef',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=250\,\mathrm{MeV}$')
ax1.scatter(T,mu290,color='#fee0d2',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=290\,\mathrm{MeV}$')
ax1.scatter(T,mu300,color='#fc9271',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=300\,\mathrm{MeV}$')
ax1.scatter(T,mu320,color='#ef3b2c',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=320\,\mathrm{MeV}$')
ax1.scatter(T,mu380,color='#a50f15',s=10,alpha=0.8,edgecolors='none',label=r'$\mu=380\,\mathrm{MeV}$')
