...
ax1.plot(ZM300,color='#08306b',linewidth=2.5,alpha=0.8,label=r'$M=300\,\mathrm{MeV}$')
ax1.plot(ZM400,dashes=[3,2],color='#fc9271',linewidth=2.5,alpha=0.8,label=r'$M=400\,\mathrm{MeV}$')
ax1.plot(ZM500,linestyle=(0,(3,1,1,1)),color='#a50f15',linewidth=2.5,alpha=0.8,label=r'$M=500\,\mathrm{MeV}$')
...
plt.plot(ZM300-ZM300[0]+1,color='#08306b',linewidth=2,alpha=0.8)
plt.plot(ZM400-ZM400[0]+1,dashes=[3,2],color='#fc9271',linewidth=2,alpha=0.8)
plt.plot(ZM500-ZM500[0]+1,linestyle=(0,(3,1,1,1)),color='#a50f15',linewidth=2,alpha=0.8)
