...
# Data for plotting
mub400T1data=np.loadtxt('./mub400T1.dat')
mub301T1data=np.loadtxt('./mub301T1.dat')
p = np.linspace(-1000, 1000, 201)
# Create figure
fig=plt.figure(figsize=(4.5, 3.5))
#fig=plt.figure()
ax1=plt.subplot(1,1,1)
contour_filled = ax1.contourf(p/1000,p/1000,mub400T1data.T/10**6, levels=100, cmap='viridis', vmin=10**2/10**6, vmax=1.8*10**6/10**6)
contour        = ax1.contour(p/1000,p/1000,mub400T1data.T/10**6, levels=100, linewidths=0.2, colors='white')
...
fig.subplots_adjust(top=0.94, bottom=0.13, left=0.156, right=0.958, hspace=0.33,wspace=0.2)

fig.savefig("./mu400T0.pdf")
########################################################################
# Create figure
fig=plt.figure(figsize=(4.5, 3.5))
#fig=plt.figure()
ax1=plt.subplot(1,1,1)
contour_filled = ax1.contourf(p/1000,p/1000,mub301T1data.T/10**6, levels=100, cmap='viridis', vmin=10**2/10**6, vmax=1.98*10**6/10**6)
